...
-- Copiando estrutura do banco de dados para ordems_db
DROP DATABASE IF EXISTS `ordems_db`;
CREATE DATABASE IF NOT EXISTS `ordems_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ordems_db`;

-- Copiando estrutura para tabela ordems_db.cliente
...
-- Copiando dados para a tabela ordems_db.cliente: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.estoque_peca
...
-- Copiando dados para a tabela ordems_db.estoque_peca: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.faq
...
-- Copiando dados para a tabela ordems_db.faq: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.fornecedor
...
-- Copiando dados para a tabela ordems_db.fornecedor: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.os
...
-- Copiando dados para a tabela ordems_db.os: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.os_status
...
-- Copiando dados para a tabela ordems_db.os_status: ~6 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.peca
...
-- Copiando dados para a tabela ordems_db.peca: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.perfil
...
-- Copiando dados para a tabela ordems_db.perfil: ~4 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.relaciona_fornecedor_peca
...
-- Copiando dados para a tabela ordems_db.relaciona_fornecedor_peca: ~6 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.relaciona_os_peca
...
-- Copiando dados para a tabela ordems_db.relaciona_os_peca: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.relaciona_sku_peca
...
-- Copiando dados para a tabela ordems_db.relaciona_sku_peca: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.sku
...
-- Copiando dados para a tabela ordems_db.sku: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela ordems_db.tipo_faq
...
-- Copiando dados para a tabela ordems_db.tipo_faq: ~0 rows (aproximadamente)
...
INSERT INTO `tipo_faq` (`id_tipo_faq`, `data_cad`, `descricao`) VALUES
	...
	(2, '2019-09-17 20:33:58', 'Cadastrar Usuário');
/*!40000 ALTER TABLE `tipo_faq` ENABLE KEYS */;

-- Copiando estrutura para tabela ordems_db.usuario
...
-- Copiando dados para a tabela ordems_db.usuario: ~3 rows (aproximadamente)
